...
pfMVAMEt = cms.EDProducer("PFMETProducerMVA",
    ...
    inputFileNames = cms.PSet(
        U     = cms.FileInPath('RecoMET/METPUSubtraction/data/Max250_Weights/RecoilCor_13TeV.root'),
        DPhi  = cms.FileInPath('RecoMET/METPUSubtraction/data/Max250_Weights/PhiCor_13TeV.root'),
        CovU1 = cms.FileInPath('RecoMET/METPUSubtraction/data/Max250_Weights/CovU1_13TeV.root'),
        CovU2 = cms.FileInPath('RecoMET/METPUSubtraction/data/Max250_Weights/CovU2_13TeV.root')
