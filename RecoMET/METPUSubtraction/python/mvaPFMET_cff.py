...
pfMVAMEt = cms.EDProducer("PFMETProducerMVA",
    ...
    inputFileNames = cms.PSet(
        ...
        #U     = cms.FileInPath('RecoMET/METPUSubtraction/data/my_training/RecoilCor_13TeV_Official.root'),
        #DPhi  = cms.FileInPath('RecoMET/METPUSubtraction/data/my_training/PhiCor_13TeV_Official.root'),
        #CovU1 = cms.FileInPath('RecoMET/METPUSubtraction/data/my_training/CovU1_13TeV_Unity.root'),
        #CovU2 = cms.FileInPath('RecoMET/METPUSubtraction/data/my_training/CovU2_13TeV_Unity.root')
